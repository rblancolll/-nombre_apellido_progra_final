<%-- 
    ...
    Created on : 11/11/2022, 22:12:38
    Author     : PC GAMING
--%>
...
<html>
 <head>
            <title>Registrar Ingreso</title>
                    ...
                    <script src="js/ScriptProfe.js" type="text/javascript"></script>
...
<div class="d-flex justify-content-around mx-4 my-5">
            ...
            <div class="shadow-lg p-3 bg-white rounded">
                <form method="POST" id="form" name="form" action="profesorController">
                    ...
                    <input type="email" class="form-control" id="apellido" placeholder="" name="apellido">
                </div>
                            <div class="col">
                                <label for="telefono">clase </label>
                                <input type="text" class="form-control" placeholder="" name="clase" id="clase">
                            </div>
                        </div>
                        <div class="contenido">
          <input type="button" onclick="sendForm2()" class="btn btn-outline-success" value="Register">
